...
public class B_Registration_Search_Then_Book_Appt {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String Patient_AKU_MR_No = "008-05-05";

		// Field #03 Sehat Safar No [User Input]
		String Patient_Sehat_Safar_No = "S01731391";

		// Field #04 CNIC No [User Input]
		String Patient_CNIC_No = "02408303094121";

		// Field #05 First Name [User Input]*
		String Patient_First_Name = "Shamil";

		// Field #06 Middle Name [User Input]
		String Patient_Middle_Name = "Ahmed";

		// Field #07 Last Name [User Input]*
		String Patient_Last_Name = "Rajput";
		...
		String Patient_Email = "Inam100@gmail.com";

		// Field #10 Phone No [User Input]*
		String Patient_Phone_No = "03110866445";

		// Field #11 Alternate Phone No [User Input]
		String Patient_Alternate_Phone_No = "02421150345";

		// Field #12 City Town [User Input]*
		String Patient_City_Town = "Karachi";
...
//		String Patient_Age = "53";
		...
		String Patient_Marital_Status = "Divorce";
		...
		String Patient_Discount = "Service Charges";
		// ________________________________________________________________
...
//		}
		...
		WebElement AkuMrNo = driver.findElement(By.xpath(
		...
		WebElement SehatSafarNo = driver.findElement(By.xpath(
		...
		WebElement CNICNo = driver.findElement(By.xpath(
		...
		WebElement PhoneNo = driver.findElement(By.xpath(
		...
		WebElement AlternatePhoneNo = driver.findElement(By.xpath(
		...
		WebElement CityTown = driver.findElement(By.xpath(
...
//		}
		...
		// Locate By XPath
		WebElement AgeClick = driver.findElement(By.xpath(
...
//				.sendKeys(Patient_Age);
		...
		WebElement HomeAddress = driver.findElement(By.xpath(
		...
		// Click on Register Button Locate By XPath
		driver.findElement(By.xpath("/html/body/app-root/app-patient-registration/div/div/nav/a")).click();

		// Flow
		System.out.println("Step# 05: Return Again to Dashboard");
...
//		driver.findElement(By.xpath("//div[@aria-live='assertive']//div//simple-snack-bar//div//button")).click();
		...
		// Flow
		System.out.println("Step# 06: In Dashboard Click on 'SEARCH PATIENT' Button ");
		...
		// Locate Snack-Br (Toast Message) and Press Ok Button
		// If Todays Appt. Screen is Empty No Any Appt. is Booked.
//		driver.findElement(By.xpath("//div[@aria-live='assertive']//div//simple-snack-bar//div//button")).click();
...
//				.sendKeys(Patient_First_Name," ",Patient_Middle_Name," ",Patient_Last_Name);
...
//				.sendKeys(Patient_Phone_No);
		...
		// Flow
		System.out.println("Step# 07: Successfully Search the Patient [ " + Patient_First_Name + " "
		...
		// Flow
		System.out.println("Step# 08: Book New Appointment for [ " + Patient_First_Name + " " + Patient_Middle_Name
				+ " " + Patient_Last_Name + " ]");
		...
		// Flow
		System.out.println("Step# 09: Search Doctor by Specific Name");
		...
		// Flow
		System.out.println("Step# 10: Select Doctor by Specific Name");
		...
		// Flow
		System.out.println("Step# 11: Select Schedule");
		...
		// Flow
		System.out.println("Step# 12: Select Slot");
...
//		Thread.sleep(15000);
		...
		// Flow
		System.out.println("Step# 13: Confirm Appointment With Pay.");
